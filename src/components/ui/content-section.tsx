...
export const ContentSection = ({
  ...
  return (
    ...
    >
      <div
        className={`my-16 flex w-full max-w-[1000px] flex-col items-center justify-center rounded-md bg-white bg-opacity-60 p-4 pt-0 font-sans text-orange-950 lg:p-8 lg:pt-0 ${size === "normal" ? "lg:w-1/2" : "lg:w-fit"}`}
      >
        <WelcomeBanner />
